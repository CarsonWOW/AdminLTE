	...
	<body class="hold-transition skin-purple sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/rest/Role/queryRole">角色管理</a></li>
									...
									<c:forEach items="${Roles}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/rest/Role/RoleShow?RoleId=${role.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/rest/Role/DeleteRole?RoleId=${role.id}" class="btn bg-olive btn-xs">删除角色</a>
												<a href="${pageContext.request.contextPath}/rest/Role/FindOtherPermission?RoleId=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
