				...
				<table id="dataList"
					...
					<tbody>
							...
							<tr>
								...
								<td><input type="text" size="10" value="${traveller.travellertypestr }"
									readonly="readonly"></td>
								<td><input type="text" size="10" value="${traveller.name }"
									readonly="readonly"></td>
								<td><input type="text" size="20" value="${traveller.sex}"
										   readonly="readonly"></td>

								<td><input type="text" size="15" value="${traveller.phonenum}"
										   readonly="readonly"></td>

								<td><input type="text" size="28" value="${traveller.credentialstype}"
										   readonly="readonly"></td>
