	...
	<body class="hold-transition skin-purple sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/rest/user/queryAll">用户管理</a></li>
									...
									<c:forEach items="${Users}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/rest/user/UserDetil?id=${user.id}" class="btn bg-olive btn-xs">详情</a>

												<a href="${pageContext.request.contextPath}/rest/user/AddRole?userId=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
