	...
	<body class="hold-transition skin-purple sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/rest/permission/queryPermission">资源权限管理</a></li>
									...
									<c:forEach items="${permissions}" var="p">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/rest//permission/findPermissionById?id=${p.id}"  class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/rest/permission/DeletePermission?id=${p.id}" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
