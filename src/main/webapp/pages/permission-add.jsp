	...
	<body class="hold-transition skin-purple sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="${pageContext.request.contextPath}/rest/permission/queryPermission">资源权限管理</a></li>
				<li class="active">资源权限表单</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/rest/permission/AddPermission"
				method="post">
				<!-- 正文区域 -->
